...
hotels = {
    "Bengaluru": [
        {"name": "Taj MG Road", "rating": 4.7, "price_range": "₹₹₹₹", "distance_from_center": "2 km"},
        {"name": "The Leela Palace", "rating": 4.9, "price_range": "₹₹₹₹₹", "distance_from_center": "5 km"},
        {"name": "Ibis City Center", "rating": 4.2, "price_range": "₹₹", "distance_from_center": "1 km"},
        {"name": "The Oberoi", "rating": 4.8, "price_range": "₹₹₹₹₹", "distance_from_center": "3 km"},
    ],
    "Mysuru": [
        {"name": "Grand Mercure", "rating": 4.5, "price_range": "₹₹₹", "distance_from_center": "3 km"},
        {"name": "Royal Orchid Metropole", "rating": 4.6, "price_range": "₹₹₹₹", "distance_from_center": "2 km"},
        {"name": "Hotel Sandesh The Prince", "rating": 4.3, "price_range": "₹₹", "distance_from_center": "1 km"},
        {"name": "Radisson Blu Plaza", "rating": 4.7, "price_range": "₹₹₹₹", "distance_from_center": "4 km"},
    ],
    "Chennai": [
        {"name": "ITC Grand Chola", "rating": 4.8, "price_range": "₹₹₹₹₹", "distance_from_center": "7 km"},
        {"name": "The Park Chennai", "rating": 4.4, "price_range": "₹₹₹", "distance_from_center": "2 km"},
        {"name": "Taj Coromandel", "rating": 4.7, "price_range": "₹₹₹₹", "distance_from_center": "3 km"},
        {"name": "Trident Chennai", "rating": 4.6, "price_range": "₹₹₹₹", "distance_from_center": "5 km"},
    ],
    "Pondicherry": [
        {"name": "Le Pondy", "rating": 4.5, "price_range": "₹₹₹₹", "distance_from_center": "5 km"},
        {"name": "Villa Shanti", "rating": 4.6, "price_range": "₹₹₹", "distance_from_center": "1 km"},
        {"name": "The Promenade", "rating": 4.4, "price_range": "₹₹₹", "distance_from_center": "0.5 km"},
        {"name": "Palais de Mahe", "rating": 4.7, "price_range": "₹₹₹₹", "distance_from_center": "0.7 km"},
    ]
}
    ...
    for i, theme in enumerate(themes):
        with theme_cols[i % 3]:
            ...
            <div style="background-color: {theme['color']}; padding: 1.5rem; border-radius: 10px; 
                ...
                <h1 style="font-size: 2.5rem; margin: 0;">{theme['icon']}</h1>
                <h3 style="margin: 0.5rem 0;">{theme['name']}</h3>
            </div>
            """, unsafe_allow_html=True)
